...
<ul><a href="#">CRIS-CORP</a></ul>
    ...
    <h1 class="text-center p-3" style="color: #000000">Mantenimiento de Promociones</h1>
    <div class="container-fluid row">
    <form class="col-3 p3" method = "POST" >
        <h3 class="text-center" style="color: #000000">Registro de Promociones </h3>
        <?php
            include "../Conexion/conexion.php";
            include "../Controlador/registro_promocion.php";
        ?>
        <div class="mb-1">
            <label for="exampleInputEmail1" class="form-label" style="color: #000000">Nombre de Promocion</label>
            <input type="text" class="form-control" name="nombrePromocion" placeholder="Ingrese el nombre de la promocion">
        </div>
        <div class="mb-1">
            <label for="exampleInputEmail1" class="form-label" style="color: #000000">Descripcion</label>
            <input type="text" class="form-control" name="descripcion" placeholder="Ingrese la descripcion">
        </div>
        <div class="mb-1">
            <label for="exampleInputEmail1" class="form-label" style="color: #000000">Categoria de Promocion</label>
            <input type="text" class="form-control" name="categoriaPomocion" placeholder="Ingrese la categoria">
        </div>
        <div class="mb-1">
            <label for="exampleInputEmail1" class="form-label" style="color: #000000">Codigo de Promocion</label>
            <input type="text" class="form-control" name="codigoPromocion" placeholder="Ingrese el codigo de promocion">
        </div>
        <div class="mb-1">
            <label for="exampleInputEmail1" class="form-label" style="color: #000000">Estado de Promocion</label>
            <input type="text" class="form-control" name="estadoPromocion" placeholder="Ingrese el estado de promocion">
        </div>
            ...
            <tbody>
                <?php
                    ...
                    while($datos = $sql->fetch_object()){ ?>
                        <tr align="center">
                            <td><?=$datos->id?></td>
                            <td><?=$datos->nombrePromocion?></td>
                            <td><?=$datos->descripcion?></td>
                            <td><?=$datos->categoriaPromocion?></td>
                            <td><?=$datos->codigoPromocion?></td>
                            <td><?=$datos->estadoPromocion?></td>
                            <td>
                                <a href= "../Modelo/modificar_promocion.php?id=<?= $datos->id?>" class= "btn betn-small btn-warning" ><i class="fa-solid fa-pen-to-square"></i></a>
                                <a href= "../Controlador/eliminar_promocion.php/?id=<?= $datos->id?>" class= "btn betn-small btn-danger"><i class="fa-solid fa-trash"></i></a>
                            </td>
                        </tr>
                <?php   }
                ?>
