...
<body>
    ...
    <h1 class="text-center p-3" style="color: #000000">Mantenimiento de Proveedores</h1>
    <div class="container-fluid row">
    <form class="col-3 p3" method = "POST" >
        <h3 class="text-center" style="color: #000000">Registro de Proveedores</h3>
        <?php
            include "../Conexion/conexion.php";
            include "../Controlador/registro_proveedor.php";
        ?>
        <div class="mb-1">
            <label for="exampleInputEmail1" class="form-label" style="color: #000000">Nombre del Proveedor</label>
            <input type="text" class="form-control" name="nombreProveedor" placeholder="Ingrese el nombre del Proveedor">
        </div>
        <div class="mb-1">
            <label for="exampleInputEmail1" class="form-label" style="color: #000000">Telefono</label>
        ...
        <div class="mb-1">
            <label for="exampleInputEmail1" class="form-label" style="color: #000000">Servicios</label>
            <input type="text" class="form-control" name="servicios" placeholder="Ingrese sus servicios">
        </div>
        <div class="text-center">
            <button type="submit" class="btn btn-primary" name="btnregistrar" value="ok">Registrar</button>
            <button id="imprimir" class="btn btn-success" onclick="imprimirPagina()">Imprimir</button>
            <button id="generarPDF" class="btn btn-danger" onclick="generarPDF()">Generar PDF</button>
        </div>
    </form>
    <div class="col-8 p-4">
                ...
                <?php
                    ...
                    while($datos = $sql->fetch_object()){ ?>
                        <tr align="center">
                            ...
                            <td>
                                <a href= "../Modelo/modificar_proveedor.php?id=<?= $datos->id?>" class= "btn betn-small btn-warning" ><i class="fa-solid fa-pen-to-square"></i></a>
                                <a href= "../Controlador/eliminar_proveedor.php?id=<?= $datos->id?>" class= "btn betn-small btn-danger"><i class="fa-solid fa-trash"></i></a>
                            </td>
                        </tr>
                <?php   }
                ?>
